...
game.drawText("objects or you’ll lose health points:teacher - 15;failed test grades  ",25,250,s)
game.drawText(" -10. If you reach the books, you gain 5 health points,and your  ",25,275,s)
game.drawText("score increase by 1! You win by earning the score of 15 and the ",25,300,s)
game.drawText("health must be more than 20.",25,325,s)
arrowkeys.draw()
...
while not game.over:
    ...
    if character.health<=20 and game.score<=15:
        game.over=True
